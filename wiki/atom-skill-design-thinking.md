# ZeroCraft Preview — 原子 Skill 设计思考过程
...
ZeroCraft Preview 是一个 AI-native 的游戏框架。核心理念是：**游戏由原子能力（Atom Skill）组合而成**。每个 Atom Skill 是一个自描述的 ECS Capability，包含组件定义、系统逻辑、LLM 描述和编辑器参数。
