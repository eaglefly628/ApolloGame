...
const GAMES: GameEntry[] = [
  ...
  },
  {
    ...
    description: '「所有战斗都用掷骰子解决」的双人合作 Roguelike——两人各带骰池、一关一关往前闯，过关三选一拿 buff（哈迪斯式），骰子凑不够掏宝物消耗品救场，打穿一层拿局外永久解锁，全灭重开。当前=场景骨架：无限程序化房间流（分层 + 每层 2 战斗 + 1 BOSS）串成往上推进的地牢，近俯视一屏一战场、房间流式生成/卸载；精装管线（暖冷光 + 移轴景深 + 泛光 + 软影 + 天空盒）让美术不糙。战斗/骰子/敌人后续接入（见 game-d-combat-design.md）。',
    color: '#140e1f',
    accentColor: '#c084fc',
    icon: '🎲',
    status: 'playable',
