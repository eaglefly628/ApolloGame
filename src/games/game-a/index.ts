...
export { LEVEL_W1_1, LEVEL_SCROLL, LEVEL_SWITCH, LEVEL_W1_3, LEVEL_W1_4 } from './level.js';
export type { Level, Box, Spawn, Mover, Door, Switch, Collectible } from './level.js';
