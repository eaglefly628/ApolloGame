...
import {
  ...
  type PlatformCharacterDraft, type ApolloCharacterCard, type SeatCard, type CardIssue,
...
export interface SeatCharacter {
  ...
  card: ApolloCharacterCard; // 规范卡（对账/SessionOut 用·id 稳定）
...
function defaultCard(seat: number): ApolloCharacterCard {
...
export function personaFlavor(card: ApolloCharacterCard, maxLen = 40): string | undefined {
