...
import silk400 from './assets/fonts/silkscreen-400.woff2?url';
import silk700 from './assets/fonts/silkscreen-700.woff2?url';
import raj500 from './assets/fonts/rajdhani-500.woff2?url';
import raj600 from './assets/fonts/rajdhani-600.woff2?url';
import raj700 from './assets/fonts/rajdhani-700.woff2?url';
import cor500 from './assets/fonts/cormorant-500.woff2?url';
import cor600 from './assets/fonts/cormorant-600.woff2?url';
import cor700 from './assets/fonts/cormorant-700.woff2?url';
import notosans from './assets/fonts/notosanssc.woff2?url';
import notoserif from './assets/fonts/notoserifsc.woff2?url';
import zhimang from './assets/fonts/zhimangxing.woff2?url';
import mashan from './assets/fonts/mashanzheng.woff2?url';
