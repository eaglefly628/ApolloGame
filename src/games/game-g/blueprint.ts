...
export interface HeroCard { id: string; rank: string; suit: '♠'|'♥'|'♦'|'♣'; name: string; dynasty: string; title: string; story: string; curse: string }
export const HERO_CARDS: HeroCard[] = [
  // ♠ 黑桃 · 秦/战国 · 虎狼之师
  { id:'AS', rank:'A', suit:'♠', name:'白起', dynasty:'战国·秦', title:'人屠', story:'长平一役，坑赵卒四十余万，威震天下；战无不胜，最终赐剑自尽于杜邮亭，秦昭王的猜忌成其死穴。', curse:'屠戮之名永不消散，命运困于棋局，永劫轮回，无法超生。' },
  { id:'KS', rank:'K', suit:'♠', name:'王翦', dynasty:'战国·秦', title:'灭国者', story:'灭楚须六十万兵，方知天下无完美算——唯拿捏分寸者方得全身；功成后称病归田，是战国名将中极罕见的善终者。', curse:'功成须万军，孤身永不得胜，仅余谦卑方可苟活。' },
  { id:'QS', rank:'Q', suit:'♠', name:'宣太后', dynasty:'战国·秦', title:'芈太后', story:'以芈氏之身执掌秦国政权数十年，以色侍义渠王后密设伏兵灭其族——爱欲与权谋，她从不分割。', curse:'爱与权永恒拉锯，两者皆不能舍，亦皆不能全得。' },
  { id:'JS', rank:'J', suit:'♠', name:'蒙恬', dynasty:'秦朝', title:'北疆守望', story:'北逐匈奴七百里，修万里长城；始皇驾崩，受赵高矫诏逼迫，含恨吞药而死，临终叹"吾何罪于天"。', curse:'忠义无法救己于谗言，铁骨丹心终抵不过一纸假诏。' },
  { id:'10S', rank:'10', suit:'♠', name:'商鞅', dynasty:'战国·秦', title:'法家利刃', story:'以严法强秦，车裂之刑是他亲手写入律法的；秦孝公死后，新王以"谋反"罪名用他自己的律法处决了他。', curse:'以法缚人，终以法缚己，逃无可逃。' },
  { id:'9S', rank:'9', suit:'♠', name:'范雎', dynasty:'战国·秦', title:'远交近攻', story:'从濒死复仇到拜相封侯，以"远交近攻"重塑秦国战略格局；位极人臣，却在一个清晨悄然辞去，无人知其去向。', curse:'恩仇两极，魂灵永在算计中流转，无一刻安宁。' },
  { id:'8S', rank:'8', suit:'♠', name:'李牧', dynasty:'战国·赵', title:'赵之长城', story:'北御匈奴、南破秦军，赵国最后的屏障；却死于赵王听信秦国反间计，以"谋反"罪被杀，含冤入土。', curse:'勇谋无敌，永不得主君信任，英名终埋于谗言之下。' },
  { id:'7S', rank:'7', suit:'♠', name:'廉颇', dynasty:'战国·赵', title:'负荆老将', story:'负荆请罪传千古佳话；晚年遭废，流亡楚国，临死仍嚷"赵国用我否"——老骥伏枥，报国无门。', curse:'壮志至老不死，却永困于"被弃用"的悲哀中。' },
  { id:'6S', rank:'6', suit:'♠', name:'赵奢', dynasty:'战国·赵', title:'马服君', story:'阏与一战以少胜多，威震诸侯；其子赵括却在长平纸上谈兵葬送四十万赵军——父子命运，两极对照。', curse:'以少胜多的奇迹，被自己的败将之子永远遮盖。' },
  { id:'5S', rank:'5', suit:'♠', name:'乐毅', dynasty:'战国·燕', title:'五国统帅', story:'率五国联军破齐七十余城，功震诸侯；燕惠王即位后受谗言疑忌，被迫出奔赵国，抱憾终身。', curse:'功成九五，却永被一个"疑"字困住，再无用武之地。' },
  { id:'4S', rank:'4', suit:'♠', name:'孙膑', dynasty:'战国·齐', title:'兵圣孑遗', story:'被同门庞涓陷害削去膑骨，以残身设围魏救赵、马陵道万箭射杀故人——智谋逆天，肉身永残。', curse:'智慧胜天，却以残躯承载，痛楚与复仇永相随。' },
  { id:'3S', rank:'3', suit:'♠', name:'庞涓', dynasty:'战国·魏', title:'妒才之鬼', story:'妒害同门孙膑、削其膑骨；马陵道中万箭穿心，绝笔"竟成竖子之名"，以妒恶终。', curse:'嫉妒如火，永烧其魂，死于自己亲手制造的仇敌之手。' },
  { id:'2S', rank:'2', suit:'♠', name:'吴起', dynasty:'战国·楚', title:'兵法之祖', story:'为求功名杀妻投鲁，变法图强于楚；楚悼王死后被旧贵族乱箭射死于王尸之上——改革者生前身后皆死于守旧者。', curse:'一生改革强国，死于守旧之手；身后法令尽废，功业如烟。' },
  // ♥ 红心 · 汉/三国 · 铁血义气
  { id:'AH', rank:'A', suit:'♥', name:'关羽', dynasty:'三国·蜀', title:'武圣', story:'温酒斩华雄，过五关斩六将，义薄云天；却因轻敌骄傲，北伐时失荆州，麦城孤城破，被吴所杀。', curse:'义重于命，终败于一个"骄"字，英雄气短在此一刻。' },
  { id:'KH', rank:'K', suit:'♥', name:'诸葛亮', dynasty:'三国·蜀', title:'卧龙先生', story:'隆中对三分天下，六出祁山以一州之力抗全国；鞠躬尽瘁死而后已，秋风五丈原，出师未捷身先死。', curse:'智可逆天，命不遂愿，天下未复，英魂难安。' },
  { id:'QH', rank:'Q', suit:'♥', name:'貂蝉', dynasty:'汉末', title:'倾国义士', story:'以绝世美貌施连环计，离间董卓吕布，助汉室除国贼；功成后消失于史书，后世仅以传说铭记其名。', curse:'以身为器、功成无名，永不为正史所载，只余传说流传。' },
  { id:'JH', rank:'J', suit:'♥', name:'张飞', dynasty:'三国·蜀', title:'万夫莫当', story:'据水断桥一声喝退曹军；却因鞭打部将，睡梦中被割首，至死不知敌来自何处——勇猛无匹，莽直自误。', curse:'勇猛无敌，却为自身莽直所杀，死于最不堪的背叛。' },
  { id:'10H', rank:'10', suit:'♥', name:'赵云', dynasty:'三国·蜀', title:'常山赵子龙', story:'单骑救阿斗七进七出当阳坡，一生未尝败绩；功勋卓著，却终身不得封侯，永为副将之命。', curse:'忠义一生，功业难封，旷世武将只做了一辈子副将。' },
  { id:'9H', rank:'9', suit:'♥', name:'吕布', dynasty:'汉末', title:'三姓家奴', story:'无敌天下，却先弑义父丁原、再杀恩人董卓；白门楼被缚，求刘备说情不得，英雄末路，受缚就死。', curse:'无义者，终死于义之缺失，自种恶因，自食恶果。' },
  { id:'8H', rank:'8', suit:'♥', name:'周瑜', dynasty:'三国·吴', title:'赤壁英雄', story:'借东风火烧赤壁，断曹操南下霸业；三十六岁英年早逝，临终叹"既生瑜，何生亮"——才高命短。', curse:'英才盛世，却被一个"嫉"字缩短了一生，壮志未酬。' },
  { id:'7H', rank:'7', suit:'♥', name:'霍去病', dynasty:'汉朝', title:'封狼居胥', story:'十七岁封侯，深入漠北封狼居胥山；二十四岁病逝，"匈奴未灭，何以家为"成千古名言。', curse:'年少成名，天嫉英才，功业永留于二十四岁，不得终老。' },
  { id:'6H', rank:'6', suit:'♥', name:'卫青', dynasty:'汉朝', title:'大漠骠骑', story:'从骑奴之身七征匈奴未尝败绩，收复河套；功高须以谦逊自保，一生活在外戚阴影中。', curse:'功勋卓著，身份永系外戚，无法摆脱"因皇后才得势"的阴影。' },
  { id:'5H', rank:'5', suit:'♥', name:'项羽', dynasty:'楚汉', title:'西楚霸王', story:'力拔山兮气盖世，破釜沉舟灭秦军；四面楚歌，霸王别姬，乌江自刎——"无颜见江东父老"。', curse:'英雄气短，虞兮奈何，爱情与江山皆成一梦，永困于别离。' },
  { id:'4H', rank:'4', suit:'♥', name:'韩信', dynasty:'汉初', title:'兵仙', story:'胯下受辱不改志，明修栈道暗渡陈仓，助刘邦得天下；功成被诛，"狡兔死，走狗烹"，饮恨长乐宫。', curse:'旷世将才，终死于自己帮助建立的政权之手，天下最凄凉的结局。' },
  { id:'3H', rank:'3', suit:'♥', name:'刘邦', dynasty:'汉朝', title:'布衣天子', story:'泗水亭长出身，斩白蛇起义得天下；得位后诛杀异姓功臣，疑心重病缠身，即使帝王也无一日安枕。', curse:'以仁义得天下，以猜忌杀功臣，皇位至尊，终夜不得眠。' },
  { id:'2H', rank:'2', suit:'♥', name:'虞姬', dynasty:'楚汉', title:'霸王之魂', story:'随项羽南征北战，四面楚歌之夜她拔剑自刎，让霸王得以决死突围——情深义重，薄命如纸。', curse:'永困于霸王别姬那一夜，爱与死永远交织，无法从那一刻离开。' },
  // ♦ 方块 · 盛唐 · 大唐气象
  { id:'AD', rank:'A', suit:'♦', name:'李靖', dynasty:'唐初', title:'唐初战神', story:'三千轻骑灭东突厥，生擒颉利可汗献于长安；晚年示弱称疾，主动隐退，以唯一方式全身而退。', curse:'战无不胜，却需一生伏低于皇权之下，永演谦臣之态。' },
  { id:'KD', rank:'K', suit:'♦', name:'李世民', dynasty:'唐朝', title:'天可汗', story:'玄武门射杀亲兄弟、逼父退位——帝业由此开篇；贞观之治开万世太平，文治武功无双。', curse:'帝业煌煌，骨肉相残之影永不散去，至死梦魇。' },
  { id:'QD', rank:'Q', suit:'♦', name:'武则天', dynasty:'唐朝', title:'千古一后', story:'从才人到皇后再到女皇，以铁腕整肃朝堂；立无字碑，千秋功过留后人评——她知道没有字能公正。', curse:'以铁腕立世，身后毁誉两极，永无定论，只余无字碑沉默。' },
  { id:'JD', rank:'J', suit:'♦', name:'薛仁贵', dynasty:'唐朝', title:'三箭定天山', story:'三箭射杀三名将，天山回纥望风而降；老年含冤被流放，虽后昭雪，却已暮年难再征战。', curse:'威名四海，却老死于一次无辜的流放，英雄迟暮，无力回天。' },
  { id:'10D', rank:'10', suit:'♦', name:'郭子仪', dynasty:'唐朝', title:'再造唐室', story:'安史之乱中力挽狂澜，八子七婿皆封侯，以富贵善终；历史上最圆满的功臣，代价是一生谦卑自保。', curse:'功高无过，却需一生谦卑表演，寸步不离臣道，从不敢真正站直。' },
  { id:'9D', rank:'9', suit:'♦', name:'颜真卿', dynasty:'唐朝', title:'忠义书圣', story:'以一郡之兵率先抗击安禄山；七十七岁出使叛将李希烈，被缢杀，书法与节操皆传世千年。', curse:'忠义照千秋，终死于贼手，墨迹长存，魂却永困于慷慨赴死之刻。' },
  { id:'8D', rank:'8', suit:'♦', name:'高仙芝', dynasty:'唐朝', title:'怛罗斯英雄', story:'征大食于怛罗斯，是中西文明的历史碰撞；战败返京后被宦官监军诬告，不明不白斩于军前。', curse:'战场英雄，死于大营内谗言，死时仍高呼"天地鉴之"。' },
  { id:'7D', rank:'7', suit:'♦', name:'哥舒翰', dynasty:'唐朝', title:'潼关残将', story:'青海长云暗雪山，孤城遥望玉门关——边塞传奇；安史之乱中守潼关，被唐玄宗逼迫出击，一战溃败。', curse:'一世英名，毁于主君一次错误命令，无从反抗，无路可退。' },
  { id:'6D', rank:'6', suit:'♦', name:'安禄山', dynasty:'唐朝', title:'渔阳鼙鼓', story:'胡旋舞媚玄宗，身兼三镇节度使；渔阳鼙鼓动地来，掀起安史之乱，却最终死于亲生儿子之手。', curse:'以背叛得天下，亦死于背叛，因果不爽，轮回如此准确。' },
  { id:'5D', rank:'5', suit:'♦', name:'史思明', dynasty:'唐朝', title:'燕帝悲剧', story:'降而复叛，杀安庆绪自立为燕帝；与安禄山命运相同——被自己的儿子亲手所杀。', curse:'父子相残，代代不绝，权谋得位，权谋失命，无解之咒。' },
  { id:'4D', rank:'4', suit:'♦', name:'张巡', dynasty:'唐朝', title:'睢阳守城者', story:'以六千兵守睢阳抗十万叛军数月，粮尽以人为粮；是英雄还是恶魔，一千二百年后争论未止。', curse:'忠义与人性之界，永困其魂，无法自证，亦无人能裁。' },
  { id:'3D', rank:'3', suit:'♦', name:'李光弼', dynasty:'唐朝', title:'中兴名将', story:'与郭子仪并称中兴双壁，战功或在其上；晚年与宦官不和，郁郁而终，临死不得入朝。', curse:'功比郭子仪，命却天壤之别，终生困于"可惜"二字，无人能解。' },
  { id:'2D', rank:'2', suit:'♦', name:'仆固怀恩', dynasty:'唐朝', title:'两重叛将', story:'平安史之乱家族数十人殉国；受宦官诬陷，含冤叛唐，死于征途——忠奸难辨，连自己都无法定论。', curse:'两重身份，忠奸难辨，死时已不知自己究竟是忠是奸。' },
  // ♣ 梅花 · 宋/明 · 家国之殇
  { id:'AC', rank:'A', suit:'♣', name:'岳飞', dynasty:'南宋', title:'精忠报国', story:'收复失地直捣黄龙，却被十二道金牌召回；风波亭一杯鸩酒，三十九岁，"莫须有"三字成千古奇冤。', curse:'精忠难逃奸佞，英魂永困于"莫须有"三字，无处申诉。' },
  { id:'KC', rank:'K', suit:'♣', name:'戚继光', dynasty:'明朝', title:'荡倭名将', story:'练出戚家军扫平东南倭患，写兵法传世；晚年依附张居正，居正一死，被尽数落井下石，贫病交加而终。', curse:'军事天才，政治上须依附权贵，权贵倒则随之落，一生不能独立。' },
  { id:'QC', rank:'Q', suit:'♣', name:'梁红玉', dynasty:'南宋', title:'击鼓娘子', story:'黄天荡之战亲手击鼓指挥，以少战多令金军胆寒；史书不为女将立传，名字险些湮没千年历史长河。', curse:'巾帼英雄，史笔偏偏不为女将着墨，只剩民间传说流传。' },
  { id:'JC', rank:'J', suit:'♣', name:'韩世忠', dynasty:'南宋', title:'黄天荡英雄', story:'以八千兵困金兀术十万于黄天荡；岳飞死后他痛骂秦桧"莫须有"，此后郁郁终身，再不提刀。', curse:'忠义为国，只能眼睁睁看着战友含冤而死，无力回天。' },
  { id:'10C', rank:'10', suit:'♣', name:'文天祥', dynasty:'南宋', title:'丹心照汗青', story:'以丞相之身率军抗元，战败被俘；忽必烈亲劝降，不为所动，从容就义，"留取丹心照汗青"。', curse:'留取丹心照汗青，魂永困于忠义的重负，千古无可解脱。' },
  { id:'9C', rank:'9', suit:'♣', name:'辛弃疾', dynasty:'南宋', title:'词中有剑', story:'少年独闯万军阵中生擒叛将；报国无门，以词寄壮志，"醉里挑灯看剑，梦回吹角连营"。', curse:'文武双全，壮志永困于纸墨之间，一生以词抒剑，剑却再未出鞘。' },
  { id:'8C', rank:'8', suit:'♣', name:'陆秀夫', dynasty:'南宋', title:'最后的忠诚', story:'崖山海战大势已去，背起八岁幼帝跳海殉国；随行十万军民亦相继投海，南宋王朝就此终结。', curse:'最后的忠诚，永沉海底，十万英魂共困于崖山那一刻。' },
  { id:'7C', rank:'7', suit:'♣', name:'张世杰', dynasty:'南宋', title:'崖山殉国者', story:'陆秀夫跳海后，他率残舰意图突围；飓风骤起，有人劝其登岸，他绑柱不逃，随船沉没。', curse:'最后的抵抗，覆灭于天意，命运连敌人都不屑亲手终结。' },
  { id:'6C', rank:'6', suit:'♣', name:'于谦', dynasty:'明朝', title:'北京保卫者', story:'土木堡之变后力排迁都，北京保卫战大胜；英宗复辟后以"谋逆"罪被杀，抄家无余财——两袖清风死于贫穷。', curse:'救国于危难，死于自己救回的皇帝之手，两袖清风，死后无钱安葬。' },
  { id:'5C', rank:'5', suit:'♣', name:'袁崇焕', dynasty:'明朝', title:'宁远英雄', story:'宁远炮击努尔哈赤，宁锦大捷为明朝续命；被崇祯中反间计，凌迟处死，北京百姓争食其肉以泄愤。', curse:'功勋卓著，死于自己誓死守护的人民之手，千古最惨烈的奇冤。' },
  { id:'4C', rank:'4', suit:'♣', name:'郑成功', dynasty:'南明', title:'开台圣王', story:'以八万军驱逐荷兰人收复台湾；父降清子抗清，以海峡为界，家国永隔，终老异乡。', curse:'驱逐外夷，却无力回天，永望大陆，咫尺天涯。' },
  { id:'3C', rank:'3', suit:'♣', name:'史可法', dynasty:'南明', title:'扬州督师', story:'扬州城破，拒降被杀；多铎屠城十日，史可法尸骨不全，后人只寻到一件官服，以衣冠冢祭之。', curse:'以身殉国，连尸骨都不得完整，扬州之殇，与他的魂永久相连。' },
  { id:'2C', rank:'2', suit:'♣', name:'李定国', dynasty:'南明', title:'最后的光', story:'两蹶名王，使满清朝野震恐；孤军奋战至永历帝被杀，病逝异乡，临终大喊"宁死荒野，勿降清"。', curse:'孤军撑天，天不遂愿，最后的光熄于荒野，含恨异乡。' },
];
