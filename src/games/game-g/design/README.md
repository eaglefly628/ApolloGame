...
| 20 | `20-joker-catalog-150.md` | ⭐ 天机牌全集（致命翻牌养成层）：10 维度数据 kind + 牌力评估 + 一期 20 张精选 + 储备池逐期加厚（owner：不堆 150、慢慢加厚、每张牌力）|
...
**已实现**：实时三路行军战斗 + 大厅 5 屏 + 军队/布阵/小丑/星球/流派/Boss/干预全量数据，vitest ~1454 全绿。  
