...
| 20 | `20-joker-catalog-150.md` | ⭐ 天罡牌全集（养成灵魂）：3 独立牌组(52扑克/36天罡/12地支·不融入) + **三十六天罡**(10维度·精心·牌力评估·6流派招牌) + **十二地支**(升档轴) + 天机能量经济 + 逐期~20→36 |
| 21 | `21-clash-royale-economy-model.md` | ⛔ 局内经济（owner 大改·抄皇室战争 + Commands&Colors + 双牌库前线式）：点数共享池·花点数摸牌选库(普通~1/天罡~2)·天罡cap5·三路可迁移·掷命对决·先破3血。取代旧抽牌经济 |
| 22 | `22-worldview-cursed-heroes.md` | ⭐ 世界观（游戏灵魂）：每张牌=一位被诅咒的历史英雄(真实人物+背景故事)；掷命=翻其命运；三牌组=三层英雄(扑克名将/天罡星宿/地支天命)；每张牌"杀敌→称号"成长弧；数值后定·不阻塞当前 build |
