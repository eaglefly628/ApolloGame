...
> | **🏠 HOME 游戏介绍（owner 2026-06-19 · doc22 §七）** | 乙：HOME 加「游戏介绍 / 世界观」入口（同新手指导式 overlay）→ 显 **doc22 §七** 玩家文案（执掌命运之人 · 52 英雄命运之战 · 掷命=翻命 · 三牌组 · 地煞 Boss）。纯文案展示 · 古风。|
