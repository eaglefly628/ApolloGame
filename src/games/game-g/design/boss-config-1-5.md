...
- **⭐ 敌方经济 `bonusMana` +2**（owner 2026-06-21·把关1 从 98%→~94%）：列奥尼达每回合多 2 源泉=斯巴达死守人多·多铺守军。**sim 实测此为关1 最灵杠杆**（敌源泉：+0=99%·+1=98%·+2=94%）；牌力偏置(+8 才到 89%)、牌组高低(全高点仍 99%)、进攻性(全 98%) 都不如它灵——因列奥尼达守家不攻、威胁不到你家，只能靠"铺更多守军拖住"。
- **大本营血 homeHp**：**3**（owner 2026-06-21：2→3·"死守"该厚不该薄·破家多一推）
- **⛔ 关1 明确不放**：主将 debuff / stay 偏置 / 任何阴间压迫 buff（owner：教学第一关保持干净·只有最基础推进+连携·bonusMana 是明牌经济·不算阴间）。这类留给后期关。
