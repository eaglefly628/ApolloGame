...
const NON_DETERMINISTIC = new Set<string>(['Camera', 'Camera3D', 'Transform3D', 'Sky3D', 'Model3D', 'AnimState3D', 'Light3D', 'Post3D', 'Fog3D', 'Material3D', 'Vfx3D', 'WorldUI3D', 'RigidBody3D', 'ScoreTrace']);
