...
export const GAME_I_UI_INDEX: AssetIndex = parseAssetIndex({
  version: 1,
  assets: [
    { id: SKIN_METAL, type: 'texture', status: 'filled', path: '/games/game-i/art/textures/skin-metal.svg', description: '金属铆钉板按钮皮', spec: { usage: 'sprite', width: 220, height: 88 }, category: 'ui.button-skin', license: 'CC0', source: 'games/game-i (自产)' },
    { id: SKIN_WOOD, type: 'texture', status: 'filled', path: '/games/game-i/art/textures/skin-wood.svg', description: '木纹板按钮皮', spec: { usage: 'sprite', width: 220, height: 88 }, category: 'ui.button-skin', license: 'CC0', source: 'games/game-i (自产)' },
    { id: SKIN_STONE, type: 'texture', status: 'filled', path: '/games/game-i/art/textures/skin-stone.svg', description: '花岗岩石纹按钮皮', spec: { usage: 'sprite', width: 220, height: 88 }, category: 'ui.button-skin', license: 'CC0', source: 'games/game-i (自产)' },
    { id: SKIN_SCROLL, type: 'texture', status: 'filled', path: '/games/game-i/art/textures/skin-scroll.svg', description: '卷轴羊皮按钮皮', spec: { usage: 'sprite', width: 220, height: 88 }, category: 'ui.button-skin', license: 'CC0', source: 'games/game-i (自产)' },
