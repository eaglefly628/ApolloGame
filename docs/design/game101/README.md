...
| [`systems-economy.md`](./systems-economy.md) | **系统/经济深水层**（产出漏斗/次数劣化/复制泡泡/DDA订单/蛛网物·机制→数据+能力·商业化调参延后判定） | 🟢 v1 |
| [`economy-balance.md`](./economy-balance.md) | **经济数值平衡**（公平版·单日产耗闭环 + 合成成本模型 + KPI + config 锚点） | 🟢 v1 |
