...
> 配图为容器内真机截图（`shots/overview/`）。详规以各正典为准（doc19/20/22/23/24/25/26/27/28 + doc14 数值）。
...
![大厅首页](shots/overview/01-home.png)
...
![回合制三路战场](shots/overview/06-battle.png)
...
![我的牌组](shots/overview/02-decks.png)
...
![钻石商城](shots/overview/05-shop.png)
