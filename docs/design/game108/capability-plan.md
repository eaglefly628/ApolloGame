...
| **【R-108-14】出过即清零** | **按侧**把「刚出的那只手」的槽置 0 | ✗ | 🔴 **缺口 A** |
| **【R-108-02】超时顺延「保持上一回合的选择」** | 记住上回合出了哪只手 | ✗ | 🔴 **缺口 B** |
| **【R-108-30】AI「抄玩家上一手」** | 读上回合玩家出了哪只手 | ✗ | 🔴 **缺口 B**（同源） |
...
**Lead 推荐 A1**：范围最小、语义最贴（结算副作用归结算者）、且**不动全库最核心的 effect-apply**。
