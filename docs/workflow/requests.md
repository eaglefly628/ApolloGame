...
### REQ-ART-TGS吸收四件 · threejs-game-skills 对照吸收（视觉评分卡/音频线/像素QA/手册红线） · [2026-07-06] · owner 给源 → Lead 调研裁决（`art-pipeline-vision §八`） · status: **排队·待 owner 批分期**（A 评分卡=Lead 出卡+P3D/PS 挂门·B 音频线=PST/PA 工坊 M3.5·C 像素断言=P3D·D 手册回填=随 A/C 同批） · 优先级: P2 · 类型: 质量护栏吸收（不采其代码生成路线·宪法相反）
