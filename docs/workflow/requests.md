...
### REQ-G-掷骰仪式按赌注缩放 · [2026-07-01] · design G → 甲/乙（战斗屏·演出） · Game G · status: open · 优先级: P2（心流·防空洞） · 类型: 演出规则（非新数值）· 规格: `design/theory-numbers-and-flow.md §4.1.1/4.1.2`
...
### REQ-G-战斗心流实装(总) · [2026-07-01] · design G → 甲 · Game G · status: open · 优先级: **P0（owner 派·先做 Phase 1 可玩里程碑）** · 规格: `design/IMPL-PLAN-combat-flow.md`

> **owner 2026-07-01「把这套东西落成策划案·让程序员实现」**。已收敛成一份分期实装策划案（含决策台账·甲一扇门看全）。
