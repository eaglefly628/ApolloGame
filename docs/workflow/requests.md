...
### REQ-WORKSHOP-统一工作台+整链打通 · Workshop 主界面（状态机+双角色对话+订阅通道）+ 数据桥 + cart-S8 · [2026-07-10] · **owner 定稿·Lead 出图** → **指派：PST（施工）·Lead 验收** · status: **open（spec 已定稿·可开工）** · 优先级: **P0（冲刺主线）** · 类型: 产品化·工作台与打通
