...
### REQ-G-战斗逻辑批次 · [2026-06-21] · owner→甲（playtest 连发·战斗模型/AI/平衡·乙代登记） · status: **open（甲留 #1/#4/#5；#2/#3/#6 → owner 2026-06-21 转交他人·见各项标注）** · 类型: 战斗逻辑（非表现·甲域）
> owner 2026-06-21 深度 playtest 连发的一批**战斗逻辑/AI/平衡**需求——均属甲（turn-combat / 战斗驱动 / 平衡），乙代登记。乙只在甲落地钩子后接「表现」（全屏通知/fx）。
> **owner 2026-06-21 分工调整**：#2 地煞可打 / #3 敌 AI 用地煞 / #6 敌用地煞全屏通知 → **转交其他 session**（不在甲单子）；甲只留 #1 敌方牌库镜像 / #4 牌力概率反算难度旋钮 / #5 敌回合逐步演出钩子。
