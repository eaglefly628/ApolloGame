...
| 活跃/排队工单 | `docs/workflow/requests.md`（**owner 10 硬槽·满了先清后加**）；游戏工作票=各游戏 `docs/design/<game>/requests.md`（工单随游戏走）；3D=`requests-3d.md`；已完结=`requests-archive.md` |
...
- **冲刺态（owner 2026-07-15 撤出主池·非当前重点）**：7·29 审核 demo 总纲与 T3 吞吐冒烟均已撤单（纲领档 `docs/design/demo-sprint-2026-07-29.md` 保留·owner 重定目标时再开）；**Workshop 统一工作台 ✅ 完工·待 owner 验收——维护移交 PST（交接档=`docs/workflow/finish/PST-workshop-handoff.md`）**。残项：美术真 key=owner 采购；进度灯=PST 心跳队列。
