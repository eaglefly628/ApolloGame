...
> | **状态** | owner 要先提交一版(当前自走棋基础优化,全选 P1–P4)·策划F 派打磨清单·新核心案归档待启动 |
> | **上一手(策划F)完成** | owner 定节奏:**先提交一版(当前自走棋做优化)**,新核心(双人合作)**提交后启动**。策划F:① 落档 **`game-f-coop-combat-spec.md`**(⏸提交后启动);② 出**提交版打磨清单 P1–P4**(下,owner 全选)。 |
