...
- 游戏（应趋近纯数据）：`src/games/` 现 8 款 d/e/f/g/i/q/x/z（出口=**D+G**；e/i=sample；f=冻结；b/c/h/j/k/m+block-blast-mini 已删——再见到即过期信号；**A 位 2026-07-17 重启为全新项目**·与已删旧作无关·立项档 `docs/design/game-a/`）
